...
export default function AndreaniReports() {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Email da {sender}</h1>
            <p className="text-muted-foreground">Visualizza e filtra i report con classificazione priorità</p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle>Report ({filtered.length})</CardTitle>
                <CardDescription>Elenco completo dei report con classificazione</CardDescription>
              </div>
